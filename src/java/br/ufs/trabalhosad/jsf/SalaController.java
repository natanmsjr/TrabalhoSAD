...
import br.ufs.trabalhosad.session.SalaFacade;
...
public class SalaController implements Serializable {
    ...
    @EJB
    private br.ufs.trabalhosad.session.SalaFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resource/Bundle").getString("SalaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resource/Bundle").getString("SalaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resource/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resource/Bundle").getString("SalaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resource/Bundle").getString("PersistenceErrorOccured"));
        }
    }
